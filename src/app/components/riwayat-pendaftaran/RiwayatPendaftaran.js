    ...
    <section className='flex justify-center items-center px-4 py-4 md:py-10 md:px-10'>
            <div className='xl:max-w-7xl mx-auto w-full'>
                <div className='flex flex-col justify-center p-4 gap-2 border bg-blue-900 border-gray-300 rounded-lg w-full'>
                    ...
                    <div className='flex flex-col w-full justify-center gap-3 pb-5'>
                        ...
                        <div className='flex justify-end gap-3 w-full pt-5 mt-5'>
                            <button className='flex items-center gap-2 bg-red-500 text-white px-6 py-3 rounded-lg'>
                                <p>Hapus</p><BsTrash className='transition-all ease-out'/>
                            </button>
                        </div>
                    </div>
                </div>
